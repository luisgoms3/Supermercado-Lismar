...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Iniciar Sessão">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>Supermercado Lismar</title>
    <link rel="stylesheet" href="css/geral.css" media="screen">
    <link rel="stylesheet" href="css/politica_privacidade.css" media="screen">
    ...
    <meta property="og:title" content="politica_privacidade">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-ef04"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-grey-5 u-section-1" id="sec-85dc">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-align-center u-text u-text-1">Política de Privacidade</h1>
        <h6 class="u-align-left u-text u-text-2">Esta política de privacidade define como o Supermercado Lismar usa e protege todas as informações que você dá ao Supermercado Lismar quando você usa este site. O Supermercado Lismar está constantemente empenhada em garantir que a sua privacidade está protegida. Poderemos pedir que você forneça certas informações pelas quais você possa ser identificado quando usa este site, tendo você a certeza que essas informações só vão ser utilizadas de acordo com esta declaração de privacidade. O Supermercado Lismar&nbsp;reserva-se no direito de alterar esta política de tempos em tempos, atualizando esta página de acordo com as alterações que possam vir a ser implementadas. Você deve verificar esta página de tempos em tempos para garantir que você está satisfeito com as mudanças.<br>
          <br>
          <br>
          <span style="font-weight: 700;">O QUE NÓS COLETAMOS</span>
          <br>
          <br>&nbsp; &nbsp; &nbsp; Nós podemos coletar as seguintes informações:<br>
          <br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; - Nome;<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; - Informações de contato, incluindo o endereço de e-mail;<br>
          <br>
          <br>
          <span style="font-weight: 700;">O QUE FAZEMOS COM A INFORMAÇÃO QUE RECOLHEMOS<br>
          </span>
          <br>
          <br>
          <span style="font-weight: 700;">
            <span style="font-weight: 400;">&nbsp; &nbsp; &nbsp; Precisamos destas informações para entender as suas necessidades e fornecer-lhe um melhor serviço e, em particular, pelas seguintes razões:</span>
            <br>
            <br>
            <span style="font-weight: 400;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;- Manutenção de registo interno;</span>
            <br>
            <span style="font-weight: 400;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;- Podemos enviar periodicamente e-mails promocionais sobre novos produtos, ofertas especiais ou outras informações que nós pensamos que você pode achar interessante, usando o endereço de e-mail que você forneceu;<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;- De tempos a tempos, também poderemos usar as suas informações para contatá-lo para fins de pesquisa de mercado. Podemos&nbsp; &nbsp; contactá-lo por e-mail, telefone, fax ou correio. Podemos usar as informações para personalizar o site de acordo com os seus interesses.
            </span>
            <br>
            <br>SEGURANÇA
          </span>
          <br>
          <br>Estamos constantemente empenhados em garantir que as suas informações estão seguras. A fim de evitar o acesso não autorizado ou divulgação, foram estabelecidos procedimentos físicos, eletrónicos e administrativos adequados para salvaguardar e proteger as informações que coletamos online.<br>
          <br>
          <span style="font-weight: 700;">LINKS PARA OUTROS SITES<br>
          </span>
          <br>O nosso site pode conter links para outros sites de interesse. No entanto, depois de ter usado esses links, você deve notar que não temos qualquer controlo sobre esse outro site. Portanto, não podemos ser responsáveis pela proteção e privacidade de qualquer informação que você fornecer enquanto visita tais sites e tais sites não são regidos por esta declaração de privacidade. Você deve ter cautela e olhar para a declaração de privacidade aplicável ao site em questão.<br>
        </h6>
      </div>
    </section>
