...
include("ligacao.php");
$mysqli = "SELECT * FROM utilizadores";
if(!$mysqli){
...
<html style="font-size: 16px;">
  <head>
    ...
    <link rel="stylesheet" href="css/criarconta.css" media="screen">
    ...
    <meta property="og:title" content="criarconta">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-ef04"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-grey-5 u-section-1" id="sec-c78f">
      <div class="u-clearfix u-sheet u-sheet-1">
        <a href="login.php" data-page-id="32795972" class="u-btn u-btn-round u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-radius-10 u-btn-1">Iniciar Sessão</a>
        <div class="u-align-center u-border-3 u-border-grey-30 u-line u-line-vertical u-line-1"></div>
        <div class="u-align-center u-border-3 u-border-grey-30 u-line u-line-horizontal u-line-2"></div>
        <div class="u-align-center u-border-3 u-border-grey-30 u-line u-line-horizontal u-line-3"></div>
        <h3 class="u-text u-text-palette-1-base u-text-1">Criar Conta</h3>
        <h5 class="u-text u-text-2">Iniciar Sessão</h5>
        <p class="u-small-text u-text u-text-variant u-text-3">Se já tens conta inicia sessão aqui.</p>
        <div class="u-form u-form-1">
          <form action="registo.php" method="POST" class="u-clearfix u-form-spacing-10 u-inner-form" style="padding: 10px" source="custom" name="form">
            <div class="u-form-email u-form-group">
              <label for="email-fbef" class="u-form-control-hidden u-label u-label-1">email</label>
              <input type="email" placeholder="Insira um endereço de email válido" id="email-fbef" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white" required="" autofocus="autofocus">
            </div>
            <span>&nbsp;</span>
            <div class="u-form-group u-form-name u-form-group-2">
              <label for="name-296a" class="u-form-control-hidden u-label u-label-2">nome</label>
              <input type="text" placeholder="Insira seu Nome" id="name-296a" name="nome" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white" required="">
            </div>
            <span>&nbsp;</span>
            <div class="u-form-group u-form-name u-form-group-3">
              <label for="name-386e" class="u-form-control-hidden u-label u-label-3">apelido</label>
              <input type="text" placeholder="Insira seu Apelido" id="name-386e" name="apelido" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white" required="">
            </div>
            <span>&nbsp;</span>
            <div class="u-form-group u-form-name">
              <label for="name-fbef" class="u-form-control-hidden u-label u-label-4">palPasse</label>
              <input type="text" placeholder="Introduza uma palavra-passe" id="name-fbef" name="palPasse" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-10 u-white" required="">
            </div>
            <span>&nbsp;</span>
            <div class="u-form-agree u-form-group u-form-group-5">
              <input type="checkbox" id="agree-2ce5" name="agree" class="u-agree-checkbox" required="">
              <label for="agree-2ce5" class="u-label u-label-5">Li e compreendi a informação sobre o uso dos meus dados pessoais como explicado pela&nbsp;<a href="politica_privacidade.php" data-page-id="907403371" class="u-active-none u-border-none u-btn u-button-style u-hover-none u-none u-text-palette-1-base u-btn-2">Política de Privacidade<span style="font-size: 0.875rem; text-align: start; background-color: #f2f2f2; color: #111111; font-family: 'Open Sans',sans-serif;">.</span>
                </a>
              </label>
            </div>
            <div class="u-align-center u-form-group u-form-submit">
              <a href="#" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-10">Criar conta<br></a>
            ...
            <div class="u-layout-row">
              ...
              <div class="u-align-center-sm u-align-right-md u-container-style u-layout-cell u-size-20 u-size-20-md u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  <a href="" class="u-image u-logo u-image-3" data-image-width="1194" data-image-height="512">
