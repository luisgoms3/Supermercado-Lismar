...
<html style="font-size: 16px;">
  <head>
    ...
    <link rel="stylesheet" href="css/Ajuda.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-ef04"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-grey-5 u-section-1" id="sec-12af">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-align-center u-text u-text-1">Contacte-nos</h1>
        <div class="u-form u-form-1">
          <form action="tickets.php" method="POST" class="u-clearfix u-form-spacing-10 u-inner-form" style="padding: 10px" source="custom" name="form-1">
            <div class="u-form-group u-form-name">
              <label for="name-bf28" class="u-form-control-hidden u-label">Nome</label>
              <input type="text" placeholder="Insira seu Nome" id="name-bf28" name="nome" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="" autofocus="autofocus">
            </div>
            <span>&nbsp;</span>
            <div class="u-form-email u-form-group">
              <label for="email-bf28" class="u-form-control-hidden u-label">Email</label>
              <input type="email" placeholder="Insira um endereço de email válido" id="email-bf28" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <span>&nbsp;</span>
            <div class="u-form-group u-form-phone u-form-group-3">
              <label for="phone-ccc4" class="u-form-control-hidden u-label">Telefone</label>
              <input type="tel" placeholder="Insira seu telefone (ex: 913234231)" maxlength = "9" id="phone-ccc4" name="telemovel" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <span>&nbsp;</span>
            <div class="u-form-group u-form-message">
              <label for="message-bf28" class="u-form-control-hidden u-label">Mensagem</label>
              <textarea placeholder="Insira sua mensagem" rows="4" cols="50" id="message-bf28" name="mensagem" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""></textarea>
            </div>
            <span>&nbsp;</span>
            <div class="u-form-agree u-form-group u-form-group-5">
              <input type="checkbox" id="agree-5e40" name="agree" class="u-agree-checkbox" required="">
              <label for="agree-5e40" class="u-label">Eu aceito a&nbsp;<a href="politica_privacidade.php" data-page-id="907403371" class="u-active-none u-border-none u-btn u-button-style u-hover-none u-none u-text-palette-1-base u-btn-1">Política de Privacidade.</a>
              </label>
            </div>
